...
const MESSAGES = {
  fr: {
    ...
    errInvalidKey: 'Clé refusée : il faut une clé OpenRouter (sk-or-…).',
    ...
    apiKeyPlaceholder: 'Clé OpenRouter (sk-or-…)',
    ...
    apiKeyGet: 'Obtenir une clé OpenRouter',
    ...
    loading: 'Chargement',
    updateReady: 'Redémarrer pour passer à la {version}',
  ...
  en: {
    ...
    errInvalidKey: 'Key rejected: an OpenRouter key (sk-or-…) is required.',
    ...
    apiKeyPlaceholder: 'OpenRouter key (sk-or-…)',
    apiKeySave: 'Save',
    apiKeyCheck: 'Check',
    ...
    apiKeyGet: 'Get an OpenRouter key',
